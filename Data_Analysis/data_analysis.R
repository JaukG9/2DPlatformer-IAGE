# =============================================================================
# GAMIFIED EDUCATION RESEARCH — FULL STATISTICAL ANALYSIS
# =============================================================================
# Composites (verified against dashboard):
#   Engagement  = mean(q_engaged, q_attention)           [2 items]
#   Enjoyment   = mean(q_continue, q_enjoyed, q_again)   [3 items]
#   Scaffolding = mean(q_figure, q_challenge, q_helped,
#                      q_prepared, q_confident)           [5 items]
#
# Outlier removal: 1.5×IQR per variable, applied independently for each test
# Per-level L6/L7: zero times = didn't reach level → set NA before outlier step
# Completion (binary): chi-square for S1 & S2; linear probability ANOVA for S3
# =============================================================================
...
CSV_PATH <- "./Gamification Data Processing/Combined_Data.csv"   # change if needed
df <- read.csv(CSV_PATH, stringsAsFactors = FALSE, check.names = TRUE)

# Rename long / dot-encoded columns to short names
...
# Per-level: 0 = didn't reach level → NA
...
# Level-specific subsets (only players who reached that level)
...
# 1.5 × IQR outlier removal (returns NA for outliers)
...
# Open PDF output
pdf("./Data Analysis/analysis_results.pdf", width = 14, height = 10)

# =============================================================================
# SECTION 1 — ONE-WAY ANOVA BY IMPLICITNESS
# =============================================================================

cat("\n====================================================\n")
cat("SECTION 1: ONE-WAY ANOVA — IMPLICITNESS\n")
cat("====================================================\n\n")

## 1.1 Completion — Chi-square (categorical DV)
...
# =============================================================================
# SECTION 2 — WELCH T-TESTS BY ADAPTABILITY
# =============================================================================

cat("\n====================================================\n")
cat("SECTION 2: WELCH T-TESTS — ADAPTABILITY\n")
cat("====================================================\n\n")
cat("Note: Completion uses Chi-square (binary DV; equivalent to t-test on 0/1)\n\n")

## 2.1 Completion — Chi-square
...
## 2.2 Enjoyment
y2_2 <- df$enjoyment      # fresh per-variable removal
...
# =============================================================================
# SECTION 3 — TWO-WAY ANOVA (IMPLICITNESS × ADAPTABILITY)
# =============================================================================

cat("\n====================================================\n")
cat("SECTION 3: TWO-WAY ANOVA — INTERACTION\n")
cat("====================================================\n\n")
cat("Note: Completion modelled as linear probability (ANOVA on 0/1 outcome)\n\n")
...
# Save CSV
write.csv(summary_df, "./Data Analysis/analysis_summary.csv", row.names = FALSE)
